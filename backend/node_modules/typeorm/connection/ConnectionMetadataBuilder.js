...
var ConnectionMetadataBuilder = /** @class */ (function () {
    ...
    ConnectionMetadataBuilder.prototype.buildMigrations = function (migrations) {
        ...
        var allMigrationClasses = tslib_1.__spread(migrationClasses, DirectoryExportedClassesLoader_1.importClassesFromDirectories(migrationDirectories));
    ...
    ConnectionMetadataBuilder.prototype.buildSubscribers = function (subscribers) {
        ...
        var allSubscriberClasses = tslib_1.__spread(subscriberClasses, DirectoryExportedClassesLoader_1.importClassesFromDirectories(subscriberDirectories));
    ...
    ConnectionMetadataBuilder.prototype.buildEntityMetadatas = function (entities) {
        ...
        var entityClasses = entityClassesOrSchemas.filter(function (entityClass) { return (entityClass instanceof EntitySchema_1.EntitySchema) === false && entityClass.constructor.name !== "EntitySchema"; });
        var entitySchemas = entityClassesOrSchemas.filter(function (entityClass) { return entityClass instanceof EntitySchema_1.EntitySchema || entityClass.constructor.name === "EntitySchema"; });
        var allEntityClasses = tslib_1.__spread(entityClasses, DirectoryExportedClassesLoader_1.importClassesFromDirectories(entityDirectories));
        allEntityClasses.forEach(function (entityClass) {
            if (entityClass instanceof EntitySchema_1.EntitySchema || entityClass.constructor.name === "EntitySchema") {
