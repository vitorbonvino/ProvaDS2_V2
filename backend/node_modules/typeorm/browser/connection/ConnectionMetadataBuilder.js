...
var ConnectionMetadataBuilder = /** @class */ (function () {
    ...
    ConnectionMetadataBuilder.prototype.buildEntityMetadatas = function (entities) {
        ...
        var entityClasses = entityClassesOrSchemas.filter(function (entityClass) { return (entityClass instanceof EntitySchema) === false && entityClass.constructor.name !== "EntitySchema"; });
        var entitySchemas = entityClassesOrSchemas.filter(function (entityClass) { return entityClass instanceof EntitySchema || entityClass.constructor.name === "EntitySchema"; });
