...
export declare type FindOptionsOrder<E> = {
    [P in keyof E]?: E[P] extends (infer R)[] ? FindOptionsOrder<R> : E[P] extends Promise<infer R> ? FindOptionsOrder<R> : E[P] extends object ? FindOptionsOrder<E[P]> : FindOptionsOrderByValue;
};
/**
...
export declare type FindOptionsRelationKeyName<E> = {
    [K in keyof E]: E[K] extends object ? K : E[K] extends object | null ? K : E[K] extends object | undefined ? K : never;
}[keyof E];
/**
...
export declare type FindOptionsRelationKey<E> = {
    [P in keyof E]?: E[P] extends (infer R)[] ? FindOptionsRelation<R> | boolean : E[P] extends Promise<infer R> ? FindOptionsRelation<R> | boolean : FindOptionsRelation<E[P]> | boolean;
};
/**
...
export declare type FindOptionsSelect<E> = (keyof E)[] | {
    [P in keyof E]?: E[P] extends (infer R)[] ? FindOptionsSelect<R> | boolean : E[P] extends Promise<infer R> ? FindOptionsSelect<R> | boolean : E[P] extends object ? FindOptionsSelect<E[P]> | boolean : boolean;
};
/**
 * "where" in find options.
 */
export declare type FindOptionsWhereCondition<E> = {
    [P in keyof E]?: E[P] extends (infer R)[] ? FindOptionsWhere<R> | boolean | FindOperator<number> | FindAltOperator<number> : E[P] extends Promise<infer R> ? FindOptionsWhere<R> | boolean : E[P] extends Object ? FindOperator<E[P]> | FindAltOperator<E[P]> | FindOptionsWhere<E[P]> | boolean : FindOperator<E[P]> | FindAltOperator<E[P]> | E[P];
};
/**
 * "where" in find options.
