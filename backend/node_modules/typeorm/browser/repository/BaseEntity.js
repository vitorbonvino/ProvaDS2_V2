...
var BaseEntity = /** @class */ (function () {
     ...
     */
    BaseEntity.observe = function (optionsOrConditions) {
        return this.getRepository().observe(optionsOrConditions);
    };
    /**
     * Finds entities and count that match given options and returns observable.
     * Whenever new data appears that matches given query observable emits new value.
     */
    BaseEntity.observeManyAndCount = function (optionsOrConditions) {
        return this.getRepository().observeManyAndCount(optionsOrConditions);
    };
    /**
     * Finds entity that match given options and returns observable.
     * Whenever new data appears that matches given query observable emits new value.
     */
    BaseEntity.observeOne = function (optionsOrConditions) {
        return this.getRepository().observeOne(optionsOrConditions);
    };
    /**
     * Gets the entities count match given options and returns observable.
     * Whenever new data appears that matches given query observable emits new value.
     */
    BaseEntity.observeCount = function (optionsOrConditions) {
        return this.getRepository().observeCount(optionsOrConditions);
    };
    /**
